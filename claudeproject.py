...
class ImageFilterApp:
    ...
    def update_display(self):
        if self.current_image:
            ...
            self.image_coord = (x_pos, y_pos)
            self.image_dimension = (img_width, img_height)
    ...
    def apply_crop(self):
        if (self.current_image and self.crop_rectangle and 
            ...
            self.current_image = Image.fromarray(self.crop_arr_image)
